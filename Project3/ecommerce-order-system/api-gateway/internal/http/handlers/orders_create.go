...
func (h *CreateOrderHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// 3) Event для outbox — под твою сигнатуру NewOrderCreatedEvent(..., total int, items []struct{...})
	...
	// 4) OUTBOX enqueue (в рамках этой же транзакции)
